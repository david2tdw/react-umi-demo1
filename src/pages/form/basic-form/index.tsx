        ...
        >
          <FormItem
            ...
            rules={[
              {
                required: true,
                message: useIntl().formatMessage({ id: 'formandbasic-form.title.required' }),
              }
            ]}
          >
            <Input placeholder={useIntl().formatMessage({ id: 'formandbasic-form.title.placeholder' })} />
          </FormItem>
          <FormItem
            {...formItemLayout}
            ...
            rules={[
              {
                required: true,
                message: useIntl().formatMessage({ id: 'formandbasic-form.date.required' })
              }
            ]}
          >
            <RangePicker
              style={{ width: '100%' }}
              placeholder={[
                useIntl().formatMessage({ id: 'formandbasic-form.placeholder.start' }),
                useIntl().formatMessage({ id: 'formandbasic-form.placeholder.end' })
              ]}
            />
          </FormItem>
          <FormItem
            ...
            rules={[
              {
                required: true,
                message: useIntl().formatMessage({ id: 'formandbasic-form.goal.required' })
              }
            ]}
          >
            <TextArea
              style={{ minHeight: 32 }}
              placeholder={useIntl().formatMessage({ id: 'formandbasic-form.goal.placeholder' })}
              rows={4}
            />
          </FormItem>
          <FormItem
            ...
            rules={[
              {
                required: true,
                message: useIntl().formatMessage({ id: 'formandbasic-form.standard.required' })
              }
            ]}
          >
            <TextArea
              style={{ minHeight: 32 }}
              placeholder={useIntl().formatMessage({ id: 'formandbasic-form.standard.placeholder' })}
              rows={4}
            />
          </FormItem>
          <FormItem
            ...
            name="client"
          >
            <Input placeholder={useIntl().formatMessage({ id: 'formandbasic-form.client.placeholder' })} />
          </FormItem>
          <FormItem
            {...formItemLayout}
            label={
            ...
            name="invites"
          >
            <Input placeholder={useIntl().formatMessage({
          ...
          >
            <div>
              ...
              <FormItem style={{ marginBottom: 0 }} name="publicUsers">
                <Select
                  mode="multiple"
                  placeholder={useIntl().formatMessage({id: 'formandbasic-form.publicUsers.placeholder'})}
                  style={{
                    margin: '8px 0',
