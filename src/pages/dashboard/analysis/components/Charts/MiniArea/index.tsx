...
const MiniArea: React.FC<MiniAreaProps> = props => {
  ...
  const tooltip: [string, (...args: any[]) => { name?: string; value: string }] = ['x*y', (x: string, y: string) => ({
    name: x,
    value: y,
  })]

  const charHeight = height + 54

  return (
    <div className={styles.miniChart} style={{ height }}>{height}
